  ...
  return (
    <section>
      <div className="registration">
        <GiArchiveRegister />
        <p>
          Регистрация в корпоративной библиотеке необходимо проходить на личном
        ...
        <GiArchiveRegister />
        <p>
          Как только у вас появилась своя учётная запись в библиотеке, вы можете
          читать или слушать книги на любом устройстве, скачав приложение через
          Google Play или по QR-коду:
        </p>
      </div>
