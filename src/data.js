export const questions = [
  ...
  "Как я узнаю, что прочёл/прослушал меньше 300 стр/мин и моя учетка будет заблокирована?",
  ...
  [
    {
      ...
      блокировки всем, чья активность за месяц была ниже 300 мин/стр, направляется уведомление. 
