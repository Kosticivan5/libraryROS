...
export const answers = [
  ...
  [
    {
      type: "text",
      content: `Корпоративная библиотека заботится о своих пользователях, поэтому за неделю до блокировки всем, чья активность за месяц была ниже 200 стр/мин, направляется уведомление. Так, пользователь может дочитать/дослушать все самое важное.`,
    },
  ],
  [
    {
